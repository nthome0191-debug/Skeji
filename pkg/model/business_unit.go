...
type BusinessUnit struct {
	...
	Maintainers    []string  `json:"maintainers,omitempty" bson:"maintainers" validate:"omitempty,dive,required"` //todo: change to participants_map
	...
	CityLabelPairs []string  `json:"-" bson:"city_label_pairs"`
}
...
type BusinessUnitUpdate struct {
	...
	Maintainers    *[]string `json:"maintainers,omitempty" validate:"omitempty,dive,required"` //todo: change to participants_map
