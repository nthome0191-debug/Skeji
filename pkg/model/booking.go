...
type Booking struct {
	...
	Status       config.BookingStatus `json:"status" bson:"status" validate:"required,oneof=pending confirmed cancelled"`
...
type BookingUpdate struct {
	...
	Status       config.BookingStatus `json:"status,omitempty" validate:"omitempty,oneof=pending confirmed cancelled"`
